const labels = {
	...
	q2: {
		...
		questions: {
			...
			q2b: "Mám tendenciu byť príliš veľkorysý k ľuďom zastávajúcim opodstatnené stanovisko, ktorému nebola venovaná náležitá pozornosť.",
			...
			q2f: "Je pre mňa ťažké byť v popredí alebo vystupovať vo vedúcej úlohe, snáď preto, že som príliš citlivý na atmosféru v skupine.",
	...
	q6: {
		...
		questions: {
			...
			q6b: "Bol by som ochotný pracovať s človekom, ktorý prejavuje najpozitívnejší prístup, bez ohľadu na to, ako ťažko znesiteľný môže byť.",
			q6c: "Hľadal by som spôsob zmenšenia zložitosti úlohy stanovením toho, čím môžu rôzni jednotlivci najlepšie prispieť.",
